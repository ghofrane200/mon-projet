    ...
    <section id="questions" className="py-24 bg-[#0f1311] text-white">
      <div className="max-w-5xl mx-auto px-6">
          ...
          <h2 className="text-center text-4xl uppercase tracking-widest text-white mb-6 font-serif font-extrabold">
            <span className="text-[#E30613]">Questions</span> fréquemment posées
          </h2>
        
        <div className="space-y-6">
          
          <div className="border border-white/10 p-6 rounded-xl hover:bg-white hover:text-black">
            <h3 className="text-lg font-medium mb-2">
              Comment savoir quel service est adapté à mon entreprise ?
            </h3>
            <p className="text-gray-400 text-sm">
              Nous offrons une consultation gratuite pour aider à identifier les meilleurs services pour votre entreprise. Lors de la consultation, nous évaluerons vos besoins et recommanderons une approche personnalisée qui correspond à vos objectifs
            </p>
          </div>
          ...
          <div className="border border-white/10 p-6 rounded-xl hover:bg-white hover:text-black">
            <h3 className="text-lg font-medium mb-2">
              Comment fonctionne votre service de surveillance CCTV ?
            </h3>
            <p className="text-gray-400 text-sm">
