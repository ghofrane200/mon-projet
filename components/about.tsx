...
export default function About() {
  return (
    <section id="about" className="py-24 bg-black text-white  px-6 gap-12 items-center">
        <div>
          <h2 className="text-center text-lg uppercase tracking-widest text-white mb-4 ">
           À propos de nous
          </h2>
