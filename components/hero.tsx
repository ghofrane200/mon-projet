    ...
    <section className="relative min-h-screen w-full">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center min-h-screen px-4 pt-32 gap-5">
        ...
        <a
          ...
          target="_blank"
          className="inline-block bg-black/70 text-white px-6 py-3 uppercase tracking-wide text-sm border border-white hover:bg-white hover:text-black transition"
         >
